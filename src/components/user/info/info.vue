			...
			<div class="user-basic-info" v-if='personalCenter && personalCenter'>
				<div class="user-basic-l">
					<div class="user-avatar">
						<div class="image-avatar" :style="{backgroundImage : 'url(' + personalCenter.avatar || 'https://w1.daiwei.site/web_v2/bg/avatar1.jpg' + ')', backgroundSize:'cover', backgroundPosition:'center'}"></div>
					</div>
